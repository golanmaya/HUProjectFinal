            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div>
                <Link to='/' className="navbar-brand">
                  ...
                  <span className='pt-5' style={{ fontWeight: '500', fontFamily: 'monospace', fontSize: '1rem' }}>Movies</span>
                </Link>
                <div className="mb-30 footer-desc pt-2">
                  We know it's tough, Movies is a company dedicated to helping viewers just like you connect with the right movies.
                </div>
                <div className='pt-2'>
                  Copyright &copy; Movies, {new Date().getFullYear().toString()} All rights reserved.
                </div>
              </div>
            </div>
